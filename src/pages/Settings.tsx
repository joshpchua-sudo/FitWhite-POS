    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {(activeSection === 'general' || activeSection === 'security' || activeSection === 'database') && (
            <div className={cn(
              "p-8 rounded-3xl border",
              theme === 'dark' ? "bg-slate-900 border-slate-800" : "bg-white border-slate-100 shadow-sm"
            )}>
              <h3 className="font-black text-lg mb-6 flex items-center gap-2 capitalize">
                {activeSection} Settings
              </h3>
              <p className="text-sm text-slate-500">This section is currently being configured. Please check back later.</p>
            </div>
          )}
